...
class PrefUser @Inject constructor(@ApplicationContext val context: Context) : user {

    companion object {
        private const val TOKEN_KEY = "name"
    }

    private val pref = context.getSharedPreferences("hilt_test" , Context.MODE_PRIVATE)
